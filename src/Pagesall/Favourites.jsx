            ...
            {nofound ? <p className="text-3xl font-bold flex justify-center items-center">No Data Found </p> :<div className="grid mx-5 md:grid-cols-3 lg:mx-20 gap-10 my-10 ">
                {
                  ...
                  favourites.slice(0,2).map(phone=><Phonecard key={phone.id} phone={phone}></Phonecard>) 
                }
                </div>}
                <div className="flex  justify-center my-8">
            
                <button onClick={()=>setisshow(!isshow)} className="bg-emerald-500 p-2 rounded-lg font-bold">Show All</button>
                </div>
